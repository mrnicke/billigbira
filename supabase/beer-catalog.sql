...
revoke all on function public.approve_price_report(uuid, uuid, text, text, numeric, numeric, text, date, text, uuid) from public;
grant execute on function public.approve_price_report(uuid, uuid, text, text, numeric, numeric, text, date, text, uuid) to authenticated;
